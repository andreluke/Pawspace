...
export class BaseManager<T, Row> {
  constructor(
    protected getStmt: typeof statements.timeline.get,
    protected allStmt: typeof statements.timeline.getAll,
    protected deleteStmt: typeof statements.timeline.delete,
    protected map: (row: Row) => T,
  ) {}
  ...
  getAll(): T[] {
    try {
      const rows = this.allStmt.all() as Row[];
...
export class TimelineConfigManager extends BaseManager<
  TimelineConfig,
  TimelineConfigRow
> {
  constructor() {
...
export class DailyEmbedConfigManager extends BaseManager<
  DailyEmbedConfig,
  DailyEmbedConfigRow
> {
  constructor() {
...
export class VerifiedUserManager extends BaseManager<
  VerifiedUser,
  VerifiedUserRow
> {
  constructor() {
...
export class BotHistoryManager extends BaseManager<BotHistory, BotHistoryRow> {
  constructor() {
    super(
...
export class WeatherStateManager extends BaseManager<
  WeatherState,
  WeatherStateRow
> {
  constructor() {
...
export class CuriousConfigManager extends BaseManager<
  CuriousConfig,
  CuriousConfigRow
> {
  constructor() {
...
export const timelineConfig = new TimelineConfigManager();
export const dailyEmbedConfig = new DailyEmbedConfigManager();
export const verifiedUsers = new VerifiedUserManager();
export const botHistory = new BotHistoryManager();
export const weatherState = new WeatherStateManager();
export const curiousConfig = new CuriousConfigManager(); 
