...
import { GuildTextBasedChannel, Message, NewsChannel, TextChannel } from "discord.js";

const DELAY_MS = 500;

function isTextOrNewsChannel(channel: GuildTextBasedChannel): channel is TextChannel | NewsChannel {
