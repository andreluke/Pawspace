...
async function getScreenshotData(message) {
  try {
    ...
    const isSameDay = previousDate.getFullYear() === currentDate.getFullYear() && previousDate.getMonth() === currentDate.getMonth() && previousDate.getDate() === currentDate.getDate();
